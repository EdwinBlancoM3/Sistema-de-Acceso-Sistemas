                ...
                <form role="form" action="insertP.php" method="post">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" value="<?=$placa['placa']?>" name="Placa" class="form-control" id="contact-name" placeholder="No Placa">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-location-arrow "></i></div>
                            <input type="text" value="<?=$placa['estado']?>" name="Estado" class="form-control" placeholder="Estado">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-user"></i></div>
                            <input type="text" value="<?=$placa['propietario']?>" name="Propietario" class="form-control" placeholder="Propietario">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-address-card-o" aria-hidden="true"></i></div>
                            <input type="text" value="<?=$placa['Matricula']?>" name="Matricula" class="form-control" placeholder="Matricula">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-flag-checkered"></i></div>
                            <input type="text" value="<?=$placa['marca']?>" name="Marca" class="form-control" placeholder="Marca">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-car"></i></div>
                            <input type="text" value="<?=$placa['modelo']?>" name="Modelo" class="form-control" placeholder="Modelo">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-paint-brush"></i></div>
                            <input type="text" value="<?=$placa['color']?>" name="Color" class="form-control" placeholder="Color">
                        </div>
                    </div>
